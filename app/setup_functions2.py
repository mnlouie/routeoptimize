...
def nearest_node(lat_input, lon_input,cur):
    dis_near=0.05
...
def make_path(G, start_lat, start_lng, end_lat, end_lng):
#INPUT 
	start = nearest_node(start_lat,start_lng,cur)
	end = nearest_node(end_lat, end_lng,cur)
#exeption!!
...
def crawl_path(G, start_lat, start_lng, bar_lat, bar_lng, end_lat, end_lng):
	path1 = make_path(G, start_lat, start_lng, bar_lat, bar_lng)
	path2 = make_path(G, bar_lat, bar_lng, end_lat, end_lng)
	return path1, path2
